...
public:
    ...
    NanoscribeSplittingPathWriter(std::shared_ptr<ClippingResources> _res, MultiSpec &_spec, SimpleNanoscribeConfigs _nanoconfigs, PathSplitterConfigs _splitterconfs, std::string file, bool generic_ntool = true, bool generic_z = true);
