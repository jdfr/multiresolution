...
typedef struct SimpleNanoscribeConfig {
    ...
    std::string beginScript, afterbeginScript, endScript;
    ...
    std::string beginSurfaces,   endSurfaces;
    std::string afterFirstZChange;
...
protected:
    ...
    int lastType;
    int current_z_block;
    bool firstTime, beforeFirstDifferentZ;
...
public:
    ...
    virtual bool finishBeforeClose(); //use this method to write a main script that includes all subscripts
protected:
