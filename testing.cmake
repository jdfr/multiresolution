...
MACRO(TEST_MULTIRES_COMPARE_TESTLOADMULTI PREVTEST1 INPUTFILE1 PREVTEST2 INPUTFILE2 TESTNAME THELABELS_MULTIRES THELABELS_COMP)
  ...
  set(PARAMSFILE "${TEST_DIR}/${TESTNAME}_loadmulti.params.txt")
  WRITE_ARG_FILE("${PARAMSFILE}" --load-multi "${TEST_DIR}/${INPUTFILE1}" "${TEST_DIR}/${INPUTFILE2}" --save ${PRODUCT_LD} ${ARGN})  
  TEST_TEMPLATE(${TESTNAME}_loadmulti "${OUTPUTDIR}" ${multires} --response-file "${PARAMSFILE}")
